                ...
                <div class="card">
                    ...
                    <form action="proses.php" method="post" class="needs-validation" novalidate="">
                        <div class="card-body pt-0">
                                    ...
                                    <div class="col-8 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="nomor_identitas" name="nomor_identitas" class="form-control" required="" autofocus>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline py-2">
                                                    <input type="radio" id="customRadioInline1" name="jenis_kelamin" value="L" class="custom-control-input">
                                                    <label class="custom-control-label" for="customRadioInline1">Laki-Laki</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline py-2">
                                                    <input type="radio" id="customRadioInline2" name="jenis_kelamin" value="P" class="custom-control-input">
                            ...
                            <div class="row">
                                <div class="col-8 mx-auto">
                                    <button class="btn btn-primary float-right" type="submit" name="tambah">Tambah Pasien</button>
                                </div>
                            </div>
                        </div>
                    </form>
